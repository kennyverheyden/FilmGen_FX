...
public class FilmDescription extends Film{
	...
	public static ArrayList<String> readStoredDescription()
	{
		...
		for(int i=0;i<keys.size();i++)
		{
			...
			// Merge
			String mergedDescription=String.format("%4d Genre: %-12s | "+ capitalize(articleWord(hyperbolic)) + " "+ hyperbolic + " " + story + " of "+ subject1 +" and "+ subject2 +" who must "+ verb +" "+ subject3 + " in "+ location, (i+1),genre); 
